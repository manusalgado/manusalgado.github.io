$(document).ready(function(){
	...
	var banner = {
		padre: $('#banner'),
		numeroSliders: $('#banner').children('.slide').length,
		posicion : 1
	}

	var info = {
		padre: $('#info'),
		numeroSliders: $('#info').children('.slide').length,
		posicion : 1
	}
	...
	$('#banner-next').on('click', function(e){
		...
		if (banner.posicion < banner.numeroSliders) {
	...
	$('#banner-prev').on('click', function(e){
		...
		banner.posicion = banner.posicion -1;
			...
			banner.posicion = banner.numeroSliders;
		}
	...
	$('#info-next').on('click', function(e){
		...
		if (info.posicion < info.numeroSliders) {
	...
	$('#info-prev').on('click', function(e){
		...
		info.posicion = info.posicion -1;
			...
			info.posicion = info.numeroSliders;
		}
