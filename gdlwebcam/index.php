...
<html class="no-js" lang="">
    ...
    <body>
            ...
            <div class="hero">
                <div class="contenido-header">
                    ...
                    <div class="informacion-evento">
                        ...
                        <p class="ciudad"><i class="fa fa-map-marker" aria-hidden="true"></i>Guadalajara</p>
                        </div>
        ...
        <section class="seccion contenedor">
            ...
            <p>El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32 y 1.10.33 de "de Finibus Bonorum et Malorum" por Cicero son también reproducidas en su forma original exacta.</p>
        </section><!--seccion-->

        <section class="programa">
            <div class="contenedor-video">
                <video src="video/video.mp4" autoplay="" loop="" poster="img/bg-talleres.jpg">
                    ...
                    <div class="programa-evento">
                        ...
                        <div id="talleres" class="info-curso ocultar clearfix">
                            <div class="detalle-evento">
                                ...
                                <p><i class="fa fa-user" aria-hidden="true"></i>Manuel Enrique Salgado</p>
                            </div>
                            <div class="detalle-evento">
                         ...
                         <div id="conferencias" class="info-curso ocultar clearfix">
                            <div class="detalle-evento">
                                <h3>Como aprender a ser freelancer</h3>
                                <p><i class="fa fa-clock-o" aria-hidden="true"></i>10:00</p>
                                <p><i class="fa fa-calendar" aria-hidden="true"></i>10 de Diciembre</p>
                                <p><i class="fa fa-user" aria-hidden="true"></i>Gregorio Snachez</p>
                            </div>
                            <div class="detalle-evento">
        ...
        <section class="seccion">
            ...
            <div class="testimonial">
                <blockquote>
                    <p>El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32</p>
        ...
        <footer class="site-footer">
            <div class="contenedor clearfix">
                ...
                <div class="ultimos-tweets">
                    ...
                    <ul>
                        <li>El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido </li>
                        <li>El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido </li>
                        <li>El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido </li>
                    </ul>
                </div>
            ...
            <p class="copyright">Todos los derechos reservados GreenSoft Technology</p>
        </footer>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-wl_aH7YF4n-9iED35CGJl4kAVW1ekhs&callback=initMap"
          async defer></script>
